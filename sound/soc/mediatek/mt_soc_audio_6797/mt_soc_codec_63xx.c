...
#if 1 //jackymao
struct pinctrl *extspkampen;
struct pinctrl_state *ext_spkamp_en_0, *ext_spkamp_en_1;
#endif
...
#if 1 //jackymao
	  pinctrl_select_state(extspkampen, ext_spkamp_en_1);
	  printk("Ext_Speaker_Amp_Change extspkampen ON\n");
#endif
...
#if 1 //jackymao
	  pinctrl_select_state(extspkampen, ext_spkamp_en_0);
	  printk("Ext_Speaker_Amp_Change extspkampen OFF\n");
#endif
		}
	}
}
...
#if 1 //jackymao
	  struct pinctrl_state *extspkampen_default;

	  pr_debug("mtk_mt6331_codec_dev_probe1111");
	 extspkampen = devm_pinctrl_get(&pdev->dev);
	 if (IS_ERR(extspkampen)) {		 
		 pr_debug("mtk_mt6331_codec_dev_probe extspkampen err");
	 } 
	 
	 extspkampen_default = pinctrl_lookup_state(extspkampen, "ext_spkamp_endefault");
	 if (IS_ERR(extspkampen_default)) {
		 //pr_debug("mtk_mt6331_codec_dev_probe extspkampen_default err");
	 }
	 
	 ext_spkamp_en_0 = pinctrl_lookup_state(extspkampen, "ext_spkamp_en0");
	 if (IS_ERR(ext_spkamp_en_0)) {
		 pr_debug("mtk_mt6331_codec_dev_probe ext_spkamp_en_0 err");
	 } 
	 
	 ext_spkamp_en_1 = pinctrl_lookup_state(extspkampen, "ext_spkamp_en1");
	 if (IS_ERR(ext_spkamp_en_1)) {
		 pr_debug("mtk_mt6331_codec_dev_probe ext_spkamp_en_1 err");
	 }	 
#endif
