...
{
	/* called by lmk/oom, dump ion total alloc memory for debug */
	return ion_total_memory;
}

struct ion_heap *ion_mm_heap_create(struct ion_platform_heap *heap_data)
{
