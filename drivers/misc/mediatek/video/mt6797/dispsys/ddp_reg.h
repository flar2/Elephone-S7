...
#define DISP_AAL_PAT_CTRL                       (DISPSYS_AAL_BASE + 0x0BC)
...
#define DISP_REG_CONFIG_MDP_RDMA_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x840)
#define DISP_REG_CONFIG_MDP_RSZ_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x844)
#define DISP_REG_CONFIG_MDP_TDSHP_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x848)
#define DISP_REG_CONFIG_MDP_WDMA_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x84c)
#define DISP_REG_CONFIG_MDP_WROT_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x850)
#define DISP_REG_CONFIG_DISP_OVL_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x854)
#define DISP_REG_CONFIG_DISP_OVL_2L_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x858)
#define DISP_REG_CONFIG_DISP_RDMA_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x85c)
#define DISP_REG_CONFIG_DISP_WDMA0_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x860)
#define DISP_REG_CONFIG_DISP_WDMA1_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x864)
#define DISP_REG_CONFIG_DISP_GAMMA_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x868)
#define DISP_REG_CONFIG_DSI_MEM_DELSEL				(DISPSYS_CONFIG_BASE + 0x86c)
#define DISP_REG_CONFIG_DISP_UFOE_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x870)
#define DISP_REG_CONFIG_DISP_DSC_MEM_DELSEL			(DISPSYS_CONFIG_BASE + 0x874)
#define DISP_REG_CONFIG_DISP_OD_MEM_DELSEL0			(DISPSYS_CONFIG_BASE + 0x878)
#define DISP_REG_CONFIG_DISP_OD_MEM_DELSEL1			(DISPSYS_CONFIG_BASE + 0x87c)
#define DISP_REG_CONFIG_MMSYS_DEBUG_OUT_SEL			(DISPSYS_CONFIG_BASE + 0x880)
#define DISP_REG_CONFIG_MMSYS_MBIST_RP_RST_B			(DISPSYS_CONFIG_BASE + 0x884)
#define DISP_REG_CONFIG_MMSYS_MBIST_RP_FAIL			(DISPSYS_CONFIG_BASE + 0x888)
#define DISP_REG_CONFIG_MMSYS_MBIST_RP_OK			(DISPSYS_CONFIG_BASE + 0x88c)
...
#define DISP_REG_CONFIG_MDP_DL_VALID_1				(DISPSYS_CONFIG_BASE + 0x8b4)
#define DISP_REG_CONFIG_MDP_DL_READY_0				(DISPSYS_CONFIG_BASE + 0x8b8)
#define DISP_REG_CONFIG_MDP_DL_READY_1				(DISPSYS_CONFIG_BASE + 0x8bc)
#define DISP_REG_CONFIG_SMI_LARB0_GREQ				(DISPSYS_CONFIG_BASE + 0x8c0)

#define DISP_REG_CONFIG_DISP_MOUT_MASK				(DISPSYS_CONFIG_BASE + 0x8d0)
#define DISP_REG_CONFIG_MDP_MOUT_MASK				(DISPSYS_CONFIG_BASE + 0x8d4)
...
/* SMI_LARB0 */
#define DISP_REG_SMI_LARB0_MMU_EN (DISPSYS_SMI_LARB0_BASE+0xfc0)
/* SMI_LARB5 */
...
#define DISP_REG_OVL_RDMA_GREQ_NUM					(0x1F8UL)
	...
	#define FLD_OVL_RDMA_GREQ_GREQ_STOP_EN		REG_FLD_MSB_LSB(27, 27)
