...
INT32 wcn_wmtd_timeout_collect_ftrace(void)
{
	...
	if (g_core_dump) {
		...
		STP_DBG_ERR_FUNC("g_core_dump is not initialized!\n");
		aed_combo_exception(NULL, 0, (const int *)pbuf, len, WMTD_TIMEOUT_INFO_HEAD);
	}
	return 0;
}
...
INT32 wcn_psm_flag_trigger_collect_ftrace(void)
{
	...
	if (g_core_dump) {
		...
		STP_DBG_ERR_FUNC("g_core_dump is not initialized!\n");
		aed_combo_exception(NULL, 0, (const int *)pbuf, len, PSM_ABNORMAL_FLAG_INFO_HEAD);
	}
	return 0;
}
...
INT32 wcn_btif_rxd_blocked_collect_ftrace(void)
{
	...
	if (g_core_dump) {
		...
		STP_DBG_ERR_FUNC("g_core_dump is not initialized!\n");
		aed_combo_exception(NULL, 0, (const int *)pbuf, len, BTIF_RXD_BLOCKED_INFO_HEAD);
	}
	return 0;
}
#endif
...
INT32 wcn_core_dump_timeout(void)
{
	...
	if (g_core_dump) {
		...
		STP_DBG_ERR_FUNC("g_core_dump is not initialized!\n");
		aed_combo_exception(NULL, 0, (const int *)pbuf, len, TIMEOUT_INFO_HEAD);
	}
	return 0;
}
