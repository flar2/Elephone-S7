...
//#define TWO_GPIO_FLASHLIGHT_IC

/*
#if defined(TWO_GPIO_FLASHLIGHT_IC)
static int g_duty = -1;
#define LEDS_CUSTOM_MODE_THRES 	3
#endif
*/
...
/*
	...
	//{
	//	PK_DBG("FL_dim_duty sid2 %d > thres %d, FLASH mode but timeout %d", duty, LEDS_CUSTOM_MODE_THRES, g_timeOutTimeMs);	
	//	flashlight_gpio_set(FLASHLIGHT_PIN_TORCH, STATE_LOW);
	//}	
#else
