...
typedef enum GED_INFO_TAG
{
    ...
    GED_FPS,
    GED_CPU0_LOADING,
    GED_CPU1_LOADING = GED_CPU0_LOADING + 1,
    GED_CPU2_LOADING = GED_CPU0_LOADING + 2,
    GED_CPU3_LOADING = GED_CPU0_LOADING + 3,
    GED_CPU4_LOADING = GED_CPU0_LOADING + 4,
    GED_CPU5_LOADING = GED_CPU0_LOADING + 5,
    GED_CPU6_LOADING = GED_CPU0_LOADING + 6,
    GED_CPU7_LOADING = GED_CPU0_LOADING + 7,
    GED_CPU8_LOADING = GED_CPU0_LOADING + 8,
    GED_CPU9_LOADING = GED_CPU0_LOADING + 9,
    GED_UNDEFINED
} GED_INFO;
