...
static unsigned int heavy_task_threshold = 650; /* max=1023, for last_poll, threshold */
static unsigned int heavy_task_threshold2 = 650; /* max=1023 for AHT, threshold  */
