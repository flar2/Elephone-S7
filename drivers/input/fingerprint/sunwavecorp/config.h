...
#define __SUNWAVE_DETECT_ID_EN        0   // sunwave read id switch default: off
...
//optional
#if defined(CONFIG_SUNWAVECORP_MT6797_SPI1_4GRAM_FIFO)
#define __SUNWAVE_SPI_DMA_MODE_EN     0   // SPI dma transfer mode switch 1: DMA; 0: FIFO 
#else
